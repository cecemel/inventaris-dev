...
DOCKER_REPO = "inventaris-dev"
ELASTIC_IMAGE = "docker.elastic.co/elasticsearch/elasticsearch:6.2.2"
ELASTIC_CONTAINER_NAME = "inventaris-elastic-init"
ELASTIC_DATA = "$(pwd)/data/elastic"
STORAGE_PROVIDER_IMAGE = "inventaris-dev/storageprovider:latest"
STORAGE_PROVIDER_CONTAINER_NAME = "storageprovider-init"
STORAGE_PROVIDER_DATA = "$(pwd)/data/storageprovider"
STORAGE_PROVIDER_DATA_MAP = "{}:/inventaris_store".format(STORAGE_PROVIDER_DATA)
REDIS_IMAGE = "redis"
REDIS_CONTAINER_NAME = "inventaris-redis-init"
...
def start_redis():
    ...
    _exec_command("docker run "
                  "--link {}:redis "
                  "inventaris-dev/redis-checker:latest"
...
def start_storage_provider():
    ...
    _exec_command("docker run "
                  ...
                  "inventaris-dev/storageprovider-checker:latest"
...
def start_elastic():
    ...
    _exec_command("docker run "
                  "--link {}:elastic "
                  "inventaris-dev/elastic-checker:latest"
