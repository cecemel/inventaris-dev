...
DATABASE_IMAGE = "inventaris-dev/postgres:latest"
DATABASE_CONTAINER_NAME = "inventaris-migration-db"
...
def start_db():
    ...
    time.sleep(10)
    _exec_command("docker run --link {}:postgres inventaris-dev/postgres-checker:latest".format(DATABASE_CONTAINER_NAME))
